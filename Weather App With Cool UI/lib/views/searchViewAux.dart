...
import 'appbar.dart';
import 'cityAddPage.dart';

class SearchAux extends StatefulWidget {
  WeatherModel model;
  SearchAux(this.model);
  @override
  _SearchAuxState createState() => _SearchAuxState();
}

class _SearchAuxState extends State<SearchAux> {
        ...
        children: [
          ...
          Positioned(
            ...
            child: CustomAppBar(
                ...
                action: Icon(FeatherIcons.cloud,color: Colors.white,),
                ...
                child:  Stack(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(widget.model.name,style: GoogleFonts.montserrat(fontSize: 23,color: Colors.orange),),
                        Padding(
                          padding: const EdgeInsets.only(top: 5),
                          child: Text(widget.model.temprature+" F",style: GoogleFonts.poppins(fontSize: 50,color: Colors.orange,fontWeight: FontWeight.bold),),
                        ),
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 10,),
                              Text(widget.model.main,style: GoogleFonts.poppins(fontSize: 18,color: Colors.orange,fontWeight: FontWeight.bold),),
                            ],
                          ),
                        ),
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 10,),
                              Text(widget.model.Description.capitalize,style: GoogleFonts.poppins(fontSize: 18,color: Colors.orange,fontWeight: FontWeight.bold),),
                            ],
                          ),
                        ),
                      ],
            ...
            child: SizedBox(
              ...
              child: widget.model!=null?Container(
                ...
                child: ListView(
                  ...
                  children: [
                    WeatherCard(title: "Wind Speed",subtitle: widget.model.Wind_Speed,unit: "m/Sec",),
                    WeatherCard(title: "Humidity",subtitle: widget.model.Humidity,unit: "%"),
                    WeatherCard(title: "Pressure",subtitle: widget.model.Pressure,unit: "hPa"),
